...
│   ├── spec.md
│   └── uv.lock
├── v0.2.0/          # pyproject.toml の version = "0.2.0" 時点のスナップショット
│   ├── code2map/
│   ├── tests/
│   ├── pyproject.toml
│   ├── spec.md
...
| 項目 | v0.1.0 | v0.1.1 | v0.1.2 | v0.1.3 | v0.2.0 | v0.2.1（現行） |
|------|:------:|:------:|:------:|:------:|:------:|:--------------:|
| リリース日 | 2026-01-27 | 2026-02-06 | 2026-02-25 | 2026-03-12 | 2026-03-12 | 2026-05-12 |
| Javaパーサー | javalang | javalang | javalang | javalang | **tree-sitter** | tree-sitter |
| Java 8+構文対応 | ✗ | ✗ | ✗ | ✗ | ✓ | ✓ |
| パースエラーメッセージ | 空 | 空 | 空 | **詳細あり** | 詳細あり | 詳細あり |
| シンボルID（`--id-prefix`） | ✗ | ✓ | ✓ | ✓ | ✓ | ✓ |
| ファイル名サニタイズ | ✗ | ✗ | ✓ | ✓ | ✓ | ✓ |
| Python 最低バージョン | 3.9 | 3.9 | 3.9 | 3.9 | 3.9 | **3.11** |
| スナップショット | なし | `versions/v0.1.1/` | `versions/v0.1.2/` | `versions/v0.1.3/` | `versions/v0.2.0/` | —（現行） |

## 各バージョンの変更概要

### v0.2.1（現行）— 2026-05-12

**Python 最低バージョンを 3.11 に引き上げ**

- `requires-python = ">=3.11"`、classifiers から `Python :: 3.9` / `Python :: 3.10` を削除
- CI matrix を `["3.11", "3.13"]` に更新
- pytest を 9.0.3 に解決し Dependabot アラート #2（CVE-2025-71176）を解消
...
- GitHub Actions による CI（Python 3.9〜3.12、v0.2.1 で 3.11〜3.12 に変更）
